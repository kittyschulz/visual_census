...
def construct_map(city, data, path_save):
    ...
    This example creates a heatmap of luxury cars in Manhattan.
    ...
    luxury = ['Mercedes-Benz S-Class Sedan 2012', 'Jaguar XK XKR 2012', 'BMW X6 SUV 2012', 'BMW X5 SUV 2007', 'Volvo C30 Hatchback 2012', 'Audi S6 Sedan 2011', 'BMW X3 SUV 2012', 'Land Rover Range Rover SUV 2012', 'BMW M3 Coupe 2012', 'Mercedes-Benz E-Class Sedan 2012',
